...
cs << l = [ Or (delete (neg l) ls) | Or ls <- cs, not (l `elem` ls) ]
...
squaresComplete = And [ Or [ P (i,j,n) | i <- [1..3], j <- [1..3], n <- [1..9]], 
                        Or [ P (i,j,n) | i <- [1..3], j <- [4..6], n <- [1..9]], 
                        Or [ P (i,j,n) | i <- [1..3], j <- [7..9], n <- [1..9]], 
                        Or [ P (i,j,n) | i <- [4..6], j <- [1..3], n <- [1..9]], 
                        Or [ P (i,j,n) | i <- [4..6], j <- [4..6], n <- [1..9]], 
                        Or [ P (i,j,n) | i <- [4..6], j <- [7..9], n <- [1..9]], 
                        Or [ P (i,j,n) | i <- [7..9], j <- [1..3], n <- [1..9]], 
                        Or [ P (i,j,n) | i <- [7..9], j <- [4..6], n <- [1..9]],
                        Or [ P (i,j,n) | i <- [7..9], j <- [7..9], n <- [1..9]]]


zippedIndexList :: [([Integer], [Integer])]
zippedIndexList =  [(x, y) | x <- [[1..3], [4..6], [7..9]], y <- [[1..3], [4..6], [7..9]]]

...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        byte gazelleAdd = zoo.addAnimal(enclosure1.getAreaID(), gazelle);
        ...
        byte zebraAdd = zoo.addAnimal(enclosure1.getAreaID(), zebra);
        byte lionAdd = zoo.addAnimal(enclosure2.getAreaID(), lion);
        byte picnicAdd = zoo.addAnimal(picnic.getAreaID(), gazelle);
        byte notAllowedAdd = zoo.addAnimal(enclosure1.getAreaID(), shark);
        zoo.addAnimal(302, shark);
        zoo.addAnimal(302, shark);
        zoo.addAnimal(204, gazelle);
        zoo.addAnimal(105, buzzard);
        byte cageAdd = zoo.addAnimal(aquarium.getAreaID(), shark);
